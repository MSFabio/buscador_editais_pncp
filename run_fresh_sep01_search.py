...
TODAY_DATE = datetime.date(2026, 9, 1) # Today: September 1, 2026
...
def main():
    print(f"--- PNCP Search for 01/09/2026 ({NUM_PAGES} pages x {len(SEARCH_TERMS)} terms) ---", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"SEARCH RESULTS (01/09/2026):", flush=True)
    ...
    # Save JSON
    json_out = os.path.join(SCRATCH_DIR, 'sep01_bahia_results.json')
    ...
    lines_md.append("> Todos os editais listados possuem sessão pública ou prazo de recebimento de propostas agendados a partir de 01/09/2026.\n")
