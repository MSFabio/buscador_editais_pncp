...
TODAY_DATE = datetime.date(2026, 8, 11) # Current date: August 11, 2026
...
def main():
    print(f"--- Starting Fresh PNCP Search for 11/08/2026 ({NUM_PAGES} pages x {len(SEARCH_TERMS)} terms) ---", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"SEARCH RESULTS FOR BAHIA (11/08/2026):", flush=True)
    ...
    json_out = r'C:\Users\11429149760\.gemini\antigravity\scratch\aug11_bahia_results.json'
