...
TODAY_DATE = datetime.date(2026, 9, 10) # Today: September 10, 2026
...
def main():
    print(f"--- PNCP Search for 10/09/2026 ({NUM_PAGES} pages x {len(SEARCH_TERMS)} terms) ---", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"SEARCH RESULTS (10/09/2026):", flush=True)
    ...
    # Save JSON
    json_out = os.path.join(SCRATCH_DIR, 'sep10_bahia_results.json')
    ...
    lines_md.append("> Todos os editais listados possuem recebimento de propostas ou sessão pública agendados para datas futuras a partir de 10/09/2026 no estado da Bahia.\n")
