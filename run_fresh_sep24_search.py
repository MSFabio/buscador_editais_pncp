...
TODAY_DATE = datetime.date(2026, 9, 24) # Today: September 24, 2026
...
def main():
    print(f"--- PNCP Search for 24/09/2026 ({NUM_PAGES} pages x {len(SEARCH_TERMS)} terms) ---", flush=True)
    ...
    print(f"\n==========================================", flush=True)
    print(f"SEARCH RESULTS (24/09/2026):", flush=True)
    ...
    # Save JSON
    json_out = os.path.join(SCRATCH_DIR, 'sep24_bahia_results.json')
    ...
    lines_md.append("> Todos os editais listados possuem recebimento de propostas ou sessão pública agendados para datas futuras a partir de 24/09/2026 no estado da Bahia.\n")
